	...
	<div class="row p-lg-5 p-md-5">
		<div class="col-lg-8">
			...
			<div class="plswb-shop-card woocommerce-cart-form__contents">
				...
				?>
						<div class="item-card woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
							<span class="close">
							...
							<div class="total">
								<div class="count" data-title="<?php esc_attr_e('Quantity', 'woocommerce'); ?>">
									<?php
								...
								<div class="total-price" data-title="<?php esc_attr_e('Subtotal', 'woocommerce'); ?>">
									<?php
		...
		<div class="col-lg-4">
			...
			<div class="card-v2">
				<button type="submit" class="button<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button btn-primary') : ''); ?>" name="update_cart" value="<?php esc_attr_e('Update cart', 'woocommerce'); ?>"><?php esc_html_e('Update cart', 'woocommerce'); ?></button>
