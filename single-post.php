            ...
            <?php if ($maktabyar_post_options['opt-show-youtube-video']) :  ?>
                <?php if (!empty($maktabyar_post_options['opt-youtube-video-code'])) :  ?>
                    ...
                    if ($country == 'Iran') : ?>
                       ...
                       <div style="padding: 10px; background: #ff5757; margin: 0 0 20px 0; color: white; border-radius: 4px; text-align: center; box-shadow: 0px 0px 17px 0px #fb8988;">برای تماشای ویدیو ابتدا vpn خود را <span style="padding:4px;background:orange">روشن</span> کرده و صفحه را رفرش کنید.</div>
                    <?php else : ?>
