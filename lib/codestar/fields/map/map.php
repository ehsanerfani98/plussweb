...
if (!class_exists('CSF_Field_map')) {
  class CSF_Field_map extends CSF_Fields
  {
    ...
    public $esri_leaflet_geocoder_css = 'https://cdn-geoweb.s3.amazonaws.com/esri-leaflet-geocoder/0.0.1-beta.5/esri-leaflet-geocoder.css';
    public $esri_leaflet = 'https://cdn-geoweb.s3.amazonaws.com/esri-leaflet/0.0.1-beta.5/esri-leaflet.js';
    public $esri_leaflet_geocoder_js = 'https://cdn-geoweb.s3.amazonaws.com/esri-leaflet-geocoder/0.0.1-beta.5/esri-leaflet-geocoder.js';
    ...
    public function enqueue()
    {
      ...
      if (!wp_script_is('csf-leaflet')) {
        ...
        wp_enqueue_script('csf-leaflet', esc_url($this->cdn_url . $this->version . '/dist/leaflet.js'), array('csf'), $this->version, true);
        wp_enqueue_script('esri_leaflet', esc_url($this->esri_leaflet), array('csf'), $this->version, true);
        wp_enqueue_script('esri_leaflet_geocoder_js', esc_url($this->esri_leaflet_geocoder_js), array('csf'), $this->version, true);
      }
      ...
      if (!wp_style_is('csf-leaflet')) {
        ...
        wp_enqueue_style('esri_leaflet_geocoder_css', esc_url($this->esri_leaflet_geocoder_css), array(), $this->version);
      }
